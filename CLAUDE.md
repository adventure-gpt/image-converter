...
Distribute: `npm run build` → installer in dist/ → commit
Auto-update: gh repo create → bump version → tag → push → build → `gh release create` with artifacts
Landing page: static HTML + Tailwind CDN → deploy to GitHub Pages
